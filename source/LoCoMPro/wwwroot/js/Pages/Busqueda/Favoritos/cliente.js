...
function agregarFilaALaTabla(cuerpoTabla, datos) {
    ...
    if (typeof datos.nombreTienda !== 'undefined' && datos.nombreTienda !== "") {
        ...
        const cantidadArreglada = datos.cantidadEncontrada > 1 ?
            `${datos.cantidadEncontrada} productos (${parseFloat(datos.porcentajeEncontrado.toFixed(2))}%)` :
            `${datos.cantidadEncontrada} producto (${parseFloat(datos.porcentajeEncontrado.toFixed(2))}%)`
