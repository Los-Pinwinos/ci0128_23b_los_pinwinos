...
{
    /// <inheritdoc />
    public partial class BaseSprint3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    latitudVivienda = table.Column<double>(type: "float", nullable: false),
                    longitudVivienda = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    nombreProducto = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    nombreUsuario = table.Column<string>(type: "nvarchar(20)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favoritos", x => new { x.nombreProducto, x.nombreUsuario });
                    table.ForeignKey(
                        name: "FK_Favoritos_Productos_nombreProducto",
                        column: x => x.nombreProducto,
                        principalTable: "Productos",
                        principalColumn: "nombre",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favoritos_Usuario_nombreUsuario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favoritos_nombreUsuario",
                table: "Favoritos",
