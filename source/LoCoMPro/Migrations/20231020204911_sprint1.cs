    ...
    public partial class sprint1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Administrador", x => x.nombreDeUsuario);
                    table.ForeignKey(
                        name: "FK_Administrador_Usuario_nombreDeUsuario",
                        column: x => x.nombreDeUsuario,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Moderador", x => x.nombreDeUsuario);
                    table.ForeignKey(
                        name: "FK_Moderador_Usuario_nombreDeUsuario",
                        column: x => x.nombreDeUsuario,
                        principalTable: "Usuario",
                        principalColumn: "nombreDeUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    fotografia = table.Column<byte[]>(type: "varbinary(900)", nullable: false),
                    creacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    usuarioCreador = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fotografias", x => new { x.fotografia, x.creacion, x.usuarioCreador });
                    table.ForeignKey(
